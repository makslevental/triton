...
def matmul_kernel(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9):
    ...
    # LR[0]
    # A[MK] = 64x32
    a00_68 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[64, 32], element_type=T.f16(), encoding=shared, memory_space=smem, mutable_memory=True, alloc_shape=[64, 32]), src=v66, offsets=[c0_i32, c0_i32, c0_i32])
    a10_68 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[64, 32], element_type=T.f16(), encoding=shared, memory_space=smem, mutable_memory=True, alloc_shape=[64, 32]), src=v66, offsets=[c0_i32, c64_i32, c0_i32])
    a20_68 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[64, 32], element_type=T.f16(), encoding=shared, memory_space=smem, mutable_memory=True, alloc_shape=[64, 32]), src=v66, offsets=[c0_i32, c128_i32, c0_i32])
    a30_68 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[64, 32], element_type=T.f16(), encoding=shared, memory_space=smem, mutable_memory=True, alloc_shape=[64, 32]), src=v66, offsets=[c0_i32, c192_i32, c0_i32])
    a01_68 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[64, 32], element_type=T.f16(), encoding=shared, memory_space=smem, mutable_memory=True, alloc_shape=[64, 32]), src=v66, offsets=[c0_i32, c0_i32, c32_i32])
    a11_68 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[64, 32], element_type=T.f16(), encoding=shared, memory_space=smem, mutable_memory=True, alloc_shape=[64, 32]), src=v66, offsets=[c0_i32, c64_i32, c32_i32])
    a21_68 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[64, 32], element_type=T.f16(), encoding=shared, memory_space=smem, mutable_memory=True, alloc_shape=[64, 32]), src=v66, offsets=[c0_i32, c128_i32, c32_i32])
    a31_68 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[64, 32], element_type=T.f16(), encoding=shared, memory_space=smem, mutable_memory=True, alloc_shape=[64, 32]), src=v66, offsets=[c0_i32, c192_i32, c32_i32])
    # B[NK] = 32x64
    b00_69 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[32, 64], element_type=T.f16(), encoding=shared1, memory_space=smem, mutable_memory=True, alloc_shape=[32, 64]), src=v67, offsets=[c0_i32, c0_i32, c0_i32])
    b10_69 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[32, 64], element_type=T.f16(), encoding=shared1, memory_space=smem, mutable_memory=True, alloc_shape=[32, 64]), src=v67, offsets=[c0_i32, c0_i32, c64_i32])
    b20_69 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[32, 64], element_type=T.f16(), encoding=shared1, memory_space=smem, mutable_memory=True, alloc_shape=[32, 64]), src=v67, offsets=[c0_i32, c0_i32, c128_i32])
    b30_69 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[32, 64], element_type=T.f16(), encoding=shared1, memory_space=smem, mutable_memory=True, alloc_shape=[32, 64]), src=v67, offsets=[c0_i32, c0_i32, c192_i32])
    b01_69 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[32, 64], element_type=T.f16(), encoding=shared1, memory_space=smem, mutable_memory=True, alloc_shape=[32, 64]), src=v67, offsets=[c0_i32, c32_i32, c0_i32])
    b11_69 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[32, 64], element_type=T.f16(), encoding=shared1, memory_space=smem, mutable_memory=True, alloc_shape=[32, 64]), src=v67, offsets=[c0_i32, c32_i32, c64_i32])
    b21_69 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[32, 64], element_type=T.f16(), encoding=shared1, memory_space=smem, mutable_memory=True, alloc_shape=[32, 64]), src=v67, offsets=[c0_i32, c32_i32, c128_i32])
    b31_69 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[32, 64], element_type=T.f16(), encoding=shared1, memory_space=smem, mutable_memory=True, alloc_shape=[32, 64]), src=v67, offsets=[c0_i32, c32_i32, c192_i32])
    ...
    v70 = arith.subi(lhs=v31, rhs=c2_i32)
    for (
        arg10,
        [
            arg11,
        ...
        rocdl.sched_group_barrier(mask=8, size=8, group_id=0)
        rocdl.sched_barrier(mask=1030)
        w102 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[256, 64], element_type=T.f16(), encoding=shared, memory_space=smem, mutable_memory=True, alloc_shape=[256, 64]), src=v66, offsets=[c0_i32, c0_i32, c0_i32])
        ...
        g97 = amdgpu.buffer_load(result=T.tensor(256, 64, T.f16(), encoding=blocked), ptr=g96, offsets=v28, cache=1)
        ...
        rocdl.sched_group_barrier(mask=32, size=1, group_id=0)
        rocdl.sched_barrier(mask=1030)
        w103 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[64, 256], element_type=T.f16(), encoding=shared1, memory_space=smem, mutable_memory=True, alloc_shape=[64, 256]), src=v67, offsets=[c0_i32, c0_i32, c0_i32])
        ...
        g104 = amdgpu.buffer_load(result=T.tensor(64, 256, T.f16(), encoding=blocked1), ptr=g98, offsets=v50, cache=1)
    ...
    rocdl.sched_barrier(mask=0)
    v72 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[256, 64], element_type=T.f16(), encoding=shared, memory_space=smem, mutable_memory=True, alloc_shape=[256, 64]), src=v66, offsets=[c0_i32, c0_i32, c0_i32])
    ttg.local_store_10 = ttg.local_store(src=v71_2, dst=v72)
    ttg.local_store_10.attributes['OpIdx'] = amdgpu.OpIdxAttr.get(0)
    v73 = ttg.memdesc_subview(result=ttg.MemDescType.get(shape=[64, 256], element_type=T.f16(), encoding=shared1, memory_space=smem, mutable_memory=True, alloc_shape=[64, 256]), src=v67, offsets=[c0_i32, c0_i32, c0_i32])
    ...
    e88 = arith.muli(lhs=arg8, rhs=v17)
