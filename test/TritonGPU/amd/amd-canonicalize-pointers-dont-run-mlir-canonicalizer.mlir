...
// CHECK:           }
// CHECK:           %[[VAL_20:.*]] = arith.trunci %[[VAL_21:.*]]#3 : tensor<1024xi64> to tensor<1024xi32>
// CHECK:           %[[VAL_22:.*]] = tt.splat %[[VAL_21]]#2 : !tt.ptr<f32> -> tensor<1024x!tt.ptr<f32>>
...
// CHECK:           }
// CHECK:           %[[VAL_20:.*]] = arith.trunci %[[VAL_21:.*]]#4 : tensor<1024xi64> to tensor<1024xi32>
// CHECK:           %[[VAL_22:.*]] = tt.splat %[[VAL_21]]#3 : !tt.ptr<f32> -> tensor<1024x!tt.ptr<f32>>
// CHECK:           %[[VAL_23:.*]] = tt.addptr %[[VAL_22]], %[[VAL_20]] : tensor<1024x!tt.ptr<f32>>, tensor<1024xi32>
// CHECK:           %[[VAL_24:.*]] = tt.load %[[VAL_23]] : tensor<1024x!tt.ptr<f32>>
